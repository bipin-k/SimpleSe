...
public final class PageObject {
    ...
    public final Label getLabel(String fieldName, Object... args) {
        return getElement(fieldName, Label.class, args);
    }
    ...
    private <E> List<E> getElements(String fieldName, Class<E> clazz, Object... args) {
        List<WebElement> webElements = newRawElement(getJsonWebElement(fieldName, args)).getWebElements();
